export const en = {
  ...
  settings: "Settings",
  mainTitle: "Providers",
  mainDesc: "Find and compare TON Storage providers",
  subsTitle: "Subscriptions",
  subsDesc: "Earnings, traffic and alerts for your providers",
  favTitle: "Favorites",
  favDesc: "Providers you starred for quick access",
  list: "Providers",
  subs: "Subscriptions",
  fav: "Favorites",
  filters: "Filters",
  ...
  searchSubs: "Search in subscriptions",
  searchFav: "Search in favorites",
  ...
  retry: "Try again",
  favEmpty: "No favorites yet. Tap the star on any provider to add it here.",
  location: "Location",
  freeLabel: "Free",
  anyLoc: "Any",
  any: "Any",
  ...
  logout: "Log out",
  loginNeeded: "Sign in to see your subscriptions",
