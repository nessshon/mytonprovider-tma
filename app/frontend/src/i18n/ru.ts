...
export const ru: Dict = {
  ...
  mainDesc: "Поиск и фильтры по провайдерам TON Storage",
  subsTitle: "Подписки",
  subsDesc: "Доход, трафик и алерты по вашим провайдерам",
  favTitle: "Избранное",
  favDesc: "Провайдеры, отмеченные звездой, всегда под рукой",
  list: "Провайдеры",
  subs: "Подписки",
  fav: "Избранное",
  filters: "Фильтры",
  ...
  retry: "Повторить",
  favEmpty: "Пока нет избранного. Нажмите звезду у любого провайдера, чтобы добавить его сюда.",
  ...
  logout: "Выйти",
  loginNeeded: "Войдите, чтобы увидеть подписки",
